...
func TestNewFile(t *testing.T) {
	...
	l := &file{
		Config: Config{Filename: logFile(dir)},
	}
	defer l.Close()
	b := []byte("boo!")
	n, err := l.Write(b)
...
func TestDefaultFilename(t *testing.T) {
	...
	filename, _ := getLogFileName(appName, "", "", "", false)
	defer os.Remove(filename)

	l := &file{Config: Config{AppName: appName}}
	defer l.Close()
	b := []byte("boo!")
	n, err := l.Write(b)
...
func TestMaxBackups(t *testing.T) {
	...
	filename := logFile(dir)
	l := &file{Config: Config{Filename: filename, MaxSize: 10, MaxBackups: 1, UtcTime: true}}
	defer l.Close()
	b := []byte("boo!")
	n, err := l.Write(b)
	isNil(err, t)
	...
	data := []byte(`
{
	...
	equals(uint64(5), l.MaxSize, t)
	equals(10, l.MaxDays, t)
	equals(3, l.MaxBackups, t)
	equals(false, l.UtcTime, t)
